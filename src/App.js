...
const App=()=> {
  ...
  const addToCart=(data)=>{
    ...
    axios.post(`https://crudcrud.com/api/c5eeea55ecc64d03a2c90f1f1e5506ce/${ChangeEmail}`,data)
        .then((res)=>{
  ...
  useEffect(()=>{
    ...
    axios.get(`https://crudcrud.com/api/c5eeea55ecc64d03a2c90f1f1e5506ce/${ChangeEmail}`)
    .then((res)=>{
